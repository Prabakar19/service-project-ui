...
export const getAllCategory = createAction('[BOOKING] get All Category');
export const getAllCategorySuccess = createAction('[BOOKING] get All Category Success', props<{ categoryList: Category[] }>());
