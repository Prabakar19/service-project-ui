...
export const addCustomerAddress = createAction('[CUST] Add Address', props<{ address: Address; customerId: string }>());
...
export const updateCustAddress = createAction('[CUST] Update Customer Address', props<{ address: Address }>());
...
export const addSPAddress = createAction('[SP] Add Address', props<{ serviceAddress: Address; spId: string }>());
