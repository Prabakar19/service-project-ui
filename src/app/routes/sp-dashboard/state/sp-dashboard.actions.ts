...
export const editService = createAction('[SP] Edit service', props<{ service: Service; serviceId: number }>());
...
export const removeService = createAction('[SP] Remove service', props<{ serviceId: number }>());
export const removeServiceSuccess = createAction('[SP] Remove service Success', props<{ serviceId: number }>());
